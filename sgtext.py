...
def gatherNaviChara(filename):    
    ...
    try:
        f = urllib.request.urlopen("http://dv5bk1m8igv7v.cloudfront.net/asset/2220/content/sgtext/" + filename)
