...
def gatherUnitIlls(filename):
    ...
    try:
        ...
        write_to_log("BFJP Unit Illustration", "Found " + filename + "\n")
...
if __name__ == "__main__":
    ...
    write_to_log("BFJP Unit Illustration", "Found " + str(foundFilesCount) + " new files, " + str(len(alreadyExistFiles)) + " already exist files\n")
